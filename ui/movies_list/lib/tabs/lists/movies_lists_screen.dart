...
class MoviesListsScreen extends StatefulWidget {
  final GetMovieCollections getMovieCollections;

  const MoviesListsScreen({super.key, required this.getMovieCollections});

  @override
  State<MoviesListsScreen> createState() => _MoviesListsScreenState();
}

class _MoviesListsScreenState extends State<MoviesListsScreen> {
  int _totalPages = 1;
